...
const SentMessage: React.FC<MessageProps> = ({ message }) => {
  ...
  return (
    <div className="flex justify-end max-w-full items-center mb-6">
      <div className="flex max-w-fit">
        <div className="max-w-full min-h-[32px] text-2xl rounded-lg px-3 py-1 bg-red-500 text-white self-end whitespace-pre-line">
          {message.text}
        </div>
        <img
          src={photo ?? undefined}
